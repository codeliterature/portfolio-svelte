<script>
  ...
  let latestProjects = projectData.slice(0, 4);
  let name = "";
  let email = "";
  let text = "";
  let message = "";
...
<section class="py-8" id="home">
  <div class="flex items-center justify-center px-6 flex-col md:flex-row">
    ...
    <div class="px-8">
      <h1 class="font-heading tracking-wider text-2xl text-title">
        codeliterature
      </h1>
      <p class="text-wrap text-white text-justify">
        we're more than just a web development company; we're storytellers in the digital realm.
      </p>
    </div>
  </div>
</section>
  ...
  <div class="p-4">
    <div class="p-2">
      ...
      <p class="text-justify text-white p-4 text-wrap">
        Welcome to CodeLiterature! We are a dynamic web development company founded by two friends with a shared passion for coding and creativity. At CodeLiterature, we specialize in crafting visually stunning and highly functional websites tailored to meet the unique needs of our clients. Our journey began with a simple idea: to blend the art of storytelling with the power of technology, creating digital experiences that are as engaging as they are effective. With a commitment to innovation, quality, and client satisfaction, we strive to bring your visions to life through exceptional web design and development services. Join us on this exciting journey as we transform the digital landscape, one project at a time.
      </p>
    </div>
        ...
        >
          ...
          <div class="flex gap-2 items-center">
            <a
              href={project.url}
              target="_blank"
              class="font-body px-2 py-1 font-semibold rounded bg-title transition ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 hover:text-white duration-200"
              >Live Preview</a
            >
            <a
  ...
  <div class="px-4">
    <div class="flex flex-col items-center md:items-start">
      ...
      <form
        ...
        class="flex flex-col space-y-4 items-baseline mx-2 text-white"
      >
        <input
          type="text"
        ...
        />
        <button
          class="py-2 px-4 text-background bg-title rounded font-bold transition ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 hover:text-white duration-200"
          type="submit"
        >
          {#if clicked}
            <svg
